...
from functions_script import color, listen, say, clean_response, get_api_key, query
...
while k< 20:
    ...
    if (user_input.strip().lower() == "break" or user_input.strip().lower() == "quit" or user_input.strip().lower() == "exit"):
